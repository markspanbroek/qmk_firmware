 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  | Raise|       Space/Lower         |Raise | GUI  | Alt  | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, RAISE,   LOWER,   KC_SPC,  KC_SPC,  LOWER,   RAISE,   KC_RGUI, KC_RALT, KC_RCTL
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MINS, KC_EQL,  XXXXXXX, _______,
    _______, _______, _______, _______, KC_SPC,  _______, _______, KC_SPC,  _______, _______, _______, _______
),

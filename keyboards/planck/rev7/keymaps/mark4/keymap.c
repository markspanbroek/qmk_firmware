 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |    Lower           |       Raise        | GUI  | Alt  | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, LOWER,   LOWER,   LOWER,   RAISE,   RAISE,   RAISE  , KC_RGUI, KC_RALT, KC_RCTL
),

/* Movement layer (Lower)
 * ,-----------------------------------------------------------------------------------.
 * |Power |      | Play | Vol+ | Mute |  {   |   }  | Home |  Up  |  End | PGUP |  \   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_LOWER] = LAYOUT_planck_grid(
    KC_PWR,  XXXXXXX, KC_MPLY, KC_VOLU, KC_MUTE, KC_LCBR, KC_RCBR, KC_HOME, KC_UP,   KC_END,  KC_PGUP, KC_BSLS,
    _______, XXXXXXX, KC_MRWD, KC_VOLD, KC_MFFD, KC_LPRN, KC_RPRN, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_QUOT,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX, KC_MINS, KC_EQL,  XXXXXXX, _______,
